...
const projects = [
  ...
  { name: 'Keepr', icons: '', imgPath: "", path_1: "", path_2: "https://github.com/AdamRB208/keepr_dotnet_fullstack", description: "Keepr is a fullstack application with a Vue front end and a C# and SQL back end. The application is designed to be a social media style of application where users can get posts from other users, post, delete and update their own content." },
